...
for agent in range(10000):
        ...
        fullagnt=(f'{aa} {b}; {c}{d}{e}{f}6yy) {g}{h}.{i}.{j}.{k} {l}')
...
logo=("""\033[1;37m
 ...
 88ooo88 88,8P      88    88V8o 88 88       \033[1;34m𝐏 \033[yy1;37m
...
----------------------------------------------
 ...
 Author    : MUSHARF HUSSAIN

 Github    : UR DADA

 Facebook  : Musharf Hussain

 Tool Name : MUSHU BRAND

 Type type : ONLY FOR TMS GANG

 Version   : 1.9.8

----------------------------------------------

 MUSHU Pro version 1.9.8

 For Haters: TMS_GANG_TATHEER_MUSHU_NADEEM__🥵🤞
